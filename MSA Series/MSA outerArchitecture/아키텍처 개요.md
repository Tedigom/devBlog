...
> _API Gateway는 서버 최앞단에 위치하여 모든 API 호출을 받습니다. 받은 API 호출을 인증한 후, 적절한 서비스들에 메세지를 전달될 수 있도록 합니다.(routing)_ 
> ###  
_API Gateway에 대한 자세한 내용은 다음장에서 다루어 보겠습니다._ 


### Service Mesh
Service Mesh는 여러 마이크로 서비스 간 네트워크 제어합니다. 즉 서비스 간의 호출 및, 여러 서비스에 걸쳐있는 트랜잭션을 관리할 수 있습니다. 